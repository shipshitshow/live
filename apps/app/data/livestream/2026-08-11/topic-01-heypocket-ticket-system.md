...
thumbnail_prompt: "16:9 YouTube livestream thumbnail, 1920x1080, photoreal cinematic render, ultra sharp, soft editorial lighting. PALETTE: warm parchment cream, muted beige, ivory, soft brown shadows, natural skin tones, silver metal, restrained navy and black; no neon, cyberpunk, or red warning stamp. COMPOSITION: two identity-locked hosts large chest-up and cropped by the left and right edges, each roughly 32–35% of frame, framing a centered HeyPocket-to-ticket workflow. CENTER ASSET: an oversized faithful silver HeyPocket recorder in three-quarter view with thin rectangular body, softly rounded corners, brushed-metal finish, and embossed vertical pocket wordmark; one clean dark-brown arrow flows from it into a large simple support-ticket card with a duration line, summary block, and exactly two bold checkmark rows; all UI is symbolic with no readable copy. HOST LEFT: preserve Vincent from the injected reference photo, bald with light tan olive skin, stubble, green-hazel eyes, black hoodie, curious impressed expression, one palm-up presenting hand. HOST RIGHT: preserve Mitchell from the injected reference photo, dark slicked-back hair, fair skin, blue eyes, navy polo, delighted that-actually-worked expression, subtle pointing gesture toward the completed ticket. BACKGROUND: warm parchment editorial texture with soft beige vignette and faint natural-history workflow sketches. CONTRAST RULE: hosts, recorder, and ticket are large and instantly readable at mobile size. LIGHTING: warm frontal studio key light, natural skin, gentle metallic rim light around the recorder. BRANDING: top-right episode number '#25' in muted dark brown with safe margin. TEXT: no title, captions, product slogans, app names, tiny UI labels, or text except '#25'. STYLE: premium natural-history tech poster, clean Ship Shit Show live-thumbnail composition. NEGATIVE: no extra devices, invented hardware, fake logos, generic robots, dark terminal walls, clutter, distorted hands, watermarks, or reproduction of the source-image text Record · Transcribe · Summarize."
---
