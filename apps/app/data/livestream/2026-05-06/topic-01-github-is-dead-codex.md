...
> "GitHub has no CEO. Dohmke left August 2025. Microsoft didn't replace him — dissolved the role. Split leadership across three execs in three different divisions. Nobody steering. And then April happened. 85% uptime. Your merged code silently reverted. Botnet took down search. Blog post apology also went down. So today — we're not crying about it. We're rebuilding it. With Codex."
...
**Articles to pull up:**
- Hashimoto blog: https://mitchellh.com/writing/ghostty-leaving-github
- GitHub 85% uptime: https://blog.incidenthub.cloud/github-reliability-outage-history-2025-2026
...
- Pull Salesforce clip from your own stream: https://youtube.com/watch?v=NiMvki8JqQ4
- 800B lines COBOL. $3T daily commerce.
- Anthropic said "quarters not years" → IBM dropped 13.2% same day. Steepest since 2000.
...
**Articles to pull up:**
- IBM drops 13% on COBOL: https://www.theregister.com/2026/02/23/ibm_share_dive_anthropic_cobol/
...
> "GitHub isn't dying because it's bad. It's dying because it's old and leaderless and the tool Microsoft funded to compete with it is better at GitHub's job than GitHub is. We're not waiting. We're rebuilding. With Codex."
