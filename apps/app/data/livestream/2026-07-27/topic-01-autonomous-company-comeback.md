---
title: "Can Opus 5, Fable 5 & GPT-5.6 Run a Company?"
...
thumbnail_prompt: "16:9 YouTube livestream thumbnail, 1920x1080, photoreal cinematic render, ultra sharp, soft editorial lighting. PALETTE: warm parchment cream background, muted beige, ivory, soft brown shadows, natural skin tones, restrained amber and golden accents, no neon, no cyberpunk, no red warning stamp. COMPOSITION: two large host portraits cropped by the left and right edges, occupying roughly 35% of frame each, framing one oversized centered editorial object. CENTER ASSET: a charming European corner shop built as a self-running brass company machine. Above it sit three large, visually distinct mechanical executive brains arranged like a tiny leadership team: one intricate architect brain, one polished judgment brain, and one powerful production brain. Three bold brass conduits feed their plans, decisions, and code into the shop below, where two simple mechanical arms move blank pull-request cards through the business. A small empty CEO chair sits directly in front. Make the three-brain org chart and shop one clean, symmetrical silhouette readable instantly at mobile size. The visual idea is 'three AI brains running one company.' HOST LEFT: bald man, light tan olive skin, stubble, green-hazel eyes, black hoodie, impressed and slightly skeptical expression, one palm-up presenting hand toward the AI company. HOST RIGHT: man with dark wavy brown hair slicked back, navy blue polo, confused wonder, subtle wait-what gesture toward the machine. BACKGROUND: plain warm parchment paper texture with an extremely faint technical org-chart drawing, soft vignette and studio shadow. CONTRAST RULE: hosts are large and readable; the three brains feeding one company form the single unmistakable center idea. LIGHTING: soft warm studio light from the front, gentle shadows, slight golden halo around the company machine. BRANDING: top-right episode number '#24', clearly readable in muted dark brown-grey. TEXT: no title text, no numbers other than '#24', no model names, no UI labels, no logos or invented brand marks. STYLE: premium natural-history technology poster, clean Ship Shit Show livestream composition."
---

## Sources — Livestream Notes

- Title: **[LIVE] Can Opus 5, Fable 5 & GPT-5.6 Run a Company?**
- Alternate title — sharper two-model packaging: **"[LIVE] Opus 5 vs GPT-5.6: Can AI Run a Company?"**
...
- Thumbnail direction: visualize **three AI brains running one company**. Keep both hosts large and frame a single mechanical org chart: three distinct executive brains feeding plans, decisions, and code into the CornerShop machine, with the human CEO chair empty. No extra thumbnail copy and no fake model logos.
