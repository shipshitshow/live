---
title: "We Took 2 Weeks Off. AI Shipped 948 Commits."
...
thumbnail_prompt: "16:9 YouTube livestream thumbnail, 1920x1080, photoreal cinematic render, ultra sharp, soft editorial lighting. PALETTE: warm parchment cream background, muted beige, ivory, soft brown shadows, natural skin tones, restrained amber and golden accents, no neon, no cyberpunk, no red warning stamp. COMPOSITION: two large host portraits cropped by the left and right edges, occupying roughly 35% of frame each, framing one oversized centered editorial object. CENTER ASSET: a single charming European corner shop built as a self-running brass automaton, doors open and warmly lit, one large wind-up key and three bold interlocking gears visibly turning, two simple mechanical arms moving a thick stack of blank pull-request cards through the shop, and one conspicuously empty founder chair in the foreground; make the shop-machine much larger and simpler than a detailed streetscape, readable instantly at mobile size. The visual idea is 'the humans left; the company kept working.' HOST LEFT: bald man, light tan olive skin, stubble, green-hazel eyes, black hoodie, impressed and slightly disbelieving expression, one palm-up presenting hand toward the autonomous shop. HOST RIGHT: man with dark wavy brown hair slicked back, navy blue polo, confused wonder, subtle wait-what gesture toward the machine. BACKGROUND: plain warm parchment paper texture with an extremely faint two-page calendar outline drifting away behind the machine, soft vignette and studio shadow. CONTRAST RULE: hosts are large and readable; the self-running shop and empty chair form one unmistakable center silhouette. LIGHTING: soft warm studio light from the front, gentle shadows, slight golden halo around the working shop. BRANDING: top-right episode number '#24', clearly readable in muted dark brown-grey. TEXT: no title text, no numbers other than '#24', no model names, no UI labels, no logos or invented brand marks. STYLE: premium natural-history technology poster, clean Ship Shit Show livestream composition."
---

## Sources — Livestream Notes

- Title: **[LIVE] We Took 2 Weeks Off. AI Shipped 948 Commits.**
- Alternate title — autonomous-company angle: **"[LIVE] 948 Commits in 10 Days — Building Our First Autonomous Company"**
- Alternate title — model-search angle: **"[LIVE] Opus 5 vs GPT-5.6: What 948 Commits Taught Us"**
- Packaging decision: do not lead with a three-model list. Current model-launch results are crowded with interchangeable "INSANE," "just dropped," and review packaging. Lead with the unique receipt and the two-week absence; put Opus 5, Fable 5, and GPT-5.6 in the first description lines and chapters.
- Thumbnail direction: the title supplies **two weeks** and **948 commits**; the image supplies **the humans left, the company kept working**. Keep the two hosts large, but make the self-running CornerShop automaton and empty chair the single mobile-readable center idea. No extra thumbnail copy and no fake model logos.
- Description opener: **"Opus 5 landed while we were away. Fable 5 planned, GPT-5.6 Sol built, and Vincent's GitHub account authored 948 commits across 36 repositories in ten days. Today we show the receipts—and why CornerShop.dev is the first company we are deliberately building to run autonomously."**
...
## Sources — YouTube Packaging Trend Check

- Snapshot method: YouTube search result metadata and current thumbnails checked July 28, 2026 for `Claude Opus 5`, `GPT-5.6`, `Claude Fable 5`, and `autonomous AI company`. View counts below are directional snapshots, not normalized performance comparisons; channel size, upload age, topic, and distribution differ.
- Fresh Opus packaging is dominated by one model name plus a short emotional verdict: [AI Search, "Claude Opus 5 is a freak"](https://www.youtube.com/watch?v=RCsBJz4W4bA) — approximately **209K views one day after upload**; [Matthew Berman, "What did Anthropic do?! (Opus 5)"](https://www.youtube.com/watch?v=tHQ34j8_toI) — approximately **89K**; [Chase AI, "Opus 5 Just Dropped and Its Numbers Are Legit INSANE"](https://www.youtube.com/watch?v=Txse8Ux69Qg) — approximately **76K**.
...
- Show-specific conclusion: a generic model verdict would enter a saturated launch cluster, while **two weeks away + 948 commits** is a receipt no competing upload can claim. The thumbnail should complement that title with the visibly empty founder chair and still-running company—not repeat the title or imitate a fake benchmark face-off.
