...
thumbnail_prompt: "16:9 YouTube livestream thumbnail, 1920x1080, photoreal cinematic render, ultra sharp, high contrast. EDIT TARGET: preserve the established July 7 Ship Shit Show live thumbnail composition exactly—dark blue/orange split lighting, central laptop, large Vincent crop on the left, large Mitchell crop on the right, inward pointing gestures, sparks, framing, and mobile-readable faces. HOST LOCKS: use the injected Vincent and Mitchell reference photos; preserve their real identities faithfully and do not replace them with generic lookalikes. CENTER SCREEN: replace only the previous topic artwork with three clean model tiles feeding bright workflow lines into one illuminated modern corner-shop storefront below. Left tile uses the Fable butterfly motif; middle tile uses the exact injected Claude mark; right tile uses the exact injected OpenAI Blossom. Preserve injected logos exactly as flat raster assets—do not redraw or invent them. Keep the storefront bold and simple, not a UI screenshot. BRANDING: change the top-right episode number to exactly '#24'. TEXT: no title, captions, model labels, company name, or other numbers; only '#24'. NEGATIVE: no brains, robots, CEO chair, gears, fake benchmark, fake logos, clutter, host changes, pose changes, clothing changes, or extra text. STYLE: same cinematic Ship Shit Show livestream thumbnail as the July 7 reference."
---
...
- Thumbnail direction: reuse the **same Vincent and Mitchell reference photos and the same July 7 live-thumbnail composition**. Change only the center screen to Fable, Claude, and OpenAI marks feeding one illuminated CornerShop storefront; change the episode number to `#24`.
- Previous live thumbnail edit target: `/Users/decod3rs/Desktop/thumbnails/2607/260707/open-models-fable-5-thumbnail-v2-1920x1080.png`
...
- Final upload-ready thumbnail: `/Users/decod3rs/Desktop/thumbnails/2607/260727/opus-fable-gpt56-autonomous-company-live-24.jpg`
- Lossless thumbnail: `/Users/decod3rs/Desktop/thumbnails/2607/260727/opus-fable-gpt56-autonomous-company-live-24.png`
