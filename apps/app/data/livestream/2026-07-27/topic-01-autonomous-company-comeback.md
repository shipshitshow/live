...
thumbnail_prompt: "16:9 YouTube livestream thumbnail, 1920x1080, photoreal high-key editorial collage, ultra sharp, readable at mobile size. STYLE: create a completely new bright European business-magazine composition with a warm ivory paper background, bold cobalt-blue geometric shadows, restrained Claude orange and gold accents, tactile cut-paper depth, and crisp studio photography. Do not reuse the previous dark split-screen laptop layout. HOST LOCKS: use the injected Vincent and Mitchell reference photos and preserve their real identities. HOST LEFT: Vincent waist-up in a black hoodie, turned three-quarters toward center with arms folded, one eyebrow raised and a skeptical half-smile; no pointing or presenting hand. HOST RIGHT: Mitchell waist-up in a navy shirt, leaning toward center with one hand at his chin, wide-eyed analytical surprise; no pointing and no open-mouth reaction. CENTER CONTENT: a large floating fan of four finished app screens—restaurant website, TV-tracking app, analytics dashboard, and game scene—clean, polished, and visibly complete, with no readable UI copy. Above the apps, place three equally sized model emblems: a gold Fable butterfly, the exact injected Claude mark, and the exact injected OpenAI Blossom; preserve injected marks as flat raster assets. Three simple light beams connect the model emblems to the finished apps. COMPOSITION: hosts occupy roughly 28-30% of each side, faces large and uncropped, with the app portfolio dominant in the center. BRANDING: top-right episode number exactly '#24' in dark navy with safe margin. TEXT: no title, model labels, app names, captions, or other numbers; only '#24'. NEGATIVE: no old thumbnail layout, central laptop frame, pointing hands, storefront, company machine, gears, brains, CEO chair, robots, sparks, neon, dark cyberpunk background, fake logos, clutter, extra people, or watermark."
---
