---
title: "1,725 Devs Say: Local AI Needs to Be the Norm"
slug: "local-ai-norm"
source: "HN, unix.foo, DeepSeek, Kimi, MiniMax, GLM"
status: "backlog"
date: "2026-05-11"
...
- HN: "Local AI needs to be the norm" — 1,725 points, 683 comments
  - Blog: https://unix.foo/posts/local-ai-needs-to-be-norm/
- HN: "Hardware Attestation as Monopoly Enabler" — 2,044 points, 690 comments (related: control/sovereignty)
- Chinese open-weight model drops (April):
  - DeepSeek V4-Flash-Max / V4-Pro-Max
  - Kimi K2.6 (Moonshot AI, April 20)
  - MiniMax M2.7
  - GLM-5.1 (Z.ai)
  - Qwen 3.6-27B (Alibaba, April 21)
- Model drop pace: 4 Chinese labs in 12 days, all competitive at frontier
- Government AI model vetting (May 5): Google, Microsoft, xAI agree to pre-release testing
...
- Why now: Segment 3 just showed SpaceX getting 220K GPUs, Nvidia betting $40B, everything going to massive cloud clusters. Developers see the consolidation and don't like it.
- The privacy angle: Cloud AI coding = sending your entire codebase to someone else's server. Every file, every keystroke, every secret that slips through .gitignore.
...
- Meaningfully lower inference cost than Western frontier models.
- Kimi K2 running 24 tokens/second on Mac Studios. Real speed on real hardware.
- Qwen 3.6-27B from Alibaba: small enough to run on consumer hardware, good enough for real coding tasks.
...
- Government angle: US now requiring pre-release testing of frontier models (Google, Microsoft, xAI agreed May 5). White House drafting FDA-style vetting. Regulation is coming for cloud AI.
